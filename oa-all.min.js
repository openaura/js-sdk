...
function(data, textStatus, jqXHR) {
            ...
            return api.setConfig = function(conf) {
                ...
                return api_call.data.limit = config.max_particles, api_call.data.api_key = key("info"), api_call.url = config.base_api_url + "/search/" + endpoint + "?callback=?", $.ajax(api_call);
            }, api.streamRequest = function(endpoint, params, callback
, method) {
                var api_call = prep(endpoint, params, callback, method), config = cfg();
                return api_call.data.limit = config.max_particles, api_call.data.api_key = key("info"), api_call.url = config.base_api_url + "/particles/" + endpoint + "?callback=?", $.ajax(api_call);
...
: function() {
        ...
        var _ = require("underscore"), util = require("./util"), prop = util.
getProperty, Media = require("./media");
        ...
        return MediaCollection.prototype = {
            ...
            within: function(minW, minH, maxW, maxH) {
                return new MediaCollection(_.chain(this._data).filter(function(
m) {
...
, [ "require", "jquery", "underscore", "./util", "./api", "./particle", "./particleCollection", "./mediaCollection", "./media" ], function(require) {
