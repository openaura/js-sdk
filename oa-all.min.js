...
.getProperty;
        ...
        return MediaCollection.prototype = {
            smallerThan: function(w, h) {
                return new MediaCollection(_.chain(this._data).filter
(function(m) {
...
.profilePhoto(),
    ...
    }), define("app/particle", [ "require", "./util", "./mediaCollection" 
], function(require) {
...
, minH, maxW, maxH) {
        ...
        var $ = require("jquery"), _ = require("underscore"), util = require("./util"), api = require("./api"
), prop = util.getProperty, Particle = require("./particle"), ParticleCollection = require("./particleCollection"), MediaCollection = require("./mediaCollection"), Media = require("./media");
        function Aura(data) {
            this._data = Object.freeze({
...
(),
        ...
        var initialize = 
require("./initialize"), ArtistInfo = require("./artistInfo"), Aura = require("./aura"), Source = require("./source"), root = this, OA = OA || {};
