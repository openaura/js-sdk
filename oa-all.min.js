...
: function(minW, minH, maxW, maxH) {
        ...
        var $ = require("jquery"), _ = require("underscore"), util = require("./util"), api = 
require("./api"), prop = util.getProperty, Particle = require("./particle"), ParticleCollection = require("./particleCollection"), MediaCollection = require("./mediaCollection"), Media = require("./media");
        function Aura(data) {
            this._data = Object.freeze({
...
,
    ...
    }), define("app/all", [ "require", "./initialize", "./artistInfo", "./aura", "./source" ], function(
require) {
