...
.each(this._data, fn);
        ...
        var $ = require("jquery"), _ = require("underscore"), util = require("./util"), prop = 
util.getProperty, api = require("./api"), MediaCollection = require("./mediaCollection");
...
(data, "next_particles"),
        ...
        function Source(data) {
            this._data = Object.freeze({
                ...
                textParticleCount: prop(data
, "particle_stats.text_count"),
