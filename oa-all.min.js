...
filter: function(fn) {
            ...
            withMediaSmallerThan: function(w, 
h) {
                return this.filter(function(p) {
    ...
    }), define("app/aura", [ "require", "jquery", "underscore", "./util", "./api"
, "./particle", "./particleCollection", "./mediaCollection", "./media" ], function(require) {
    ...
    }), define("app/source", [ "require"
, "./util", "./api" ], function(require) {
...
status, data) {
    ...
    }), define("app/searchResult", [ "require", "jquery", "underscore", "./util", "./artistInfo", "./aura" ], function(require) {
        var $ = require("jquery"), _ = require("underscore"), util = require("./util"), prop = util.getProperty, ArtistInfo = require("./artistInfo"), Aura = require("./aura");
...
oaArtistId: function() {
            ...
            nameQualifier: function() {
                return this._data.nameQualifer;
            },
            musicbrainzGid: function() {
                return this._data.musicbrainzGid;
            },
        ...
        return SearchResults.prototype = 
{
            reqString: function() {
                return this._data.reqString;
            },
            results: function() {
            ...
            filter: function(fn) {
                return new SearchResults(_.chain(this._data.results).filter(fn).map(function(r) {
                    return r.asObject();
                }).value());
            },
            map: function(fn) {
            ...
            asObject: function() {
                return {
                    ...
                    results: _.map(this.results(), function(r) {
                        return r.asObject();
                    })
                };
            }
        }, SearchResults;
    }), define("app/search", [ "require", "jquery", "underscore", "./util", "./api", "./searchResult", "./artistInfo", "./aura" ], function(require) {
        var $ = require("jquery"), _ = require("underscore"), util = require("./util"), api = require("./api"), prop = util.getProperty, SearchResults = require("./searchResult"), ArtistInfo = require("./artistInfo"), Aura = require("./aura");
        function Search(data) {
            this._data = Object.freeze({
                results: new SearchResults(data)
            });
        }
        return Search.prototype = {}, Search.api = function() {
            return api;
        }, Search.find = function(q, cb) {
            return api
.searchRequest("artists", {
                q: q
            }, function(status, data) {
                cb(new SearchResults(data, q));
            });
        }, Search.exactInfo = function(q, cb) {
            return api.searchRequest("artists", {
                q: q
            }, function(status, data) {
            ...
            return api.searchRequest("artists", {
                ...
                var res = new SearchResults(data
, q);
                Aura.fetchByOaArtistId(res.exactMatch().oaArtistId(), cb);
            });
        }, Search;
    }), define("app/all", [ "require", "./initialize", "./artistInfo", "./aura", "./source", "./search" ], function(require) {
        var initialize = require("./initialize"), ArtistInfo = require("./artistInfo"), Aura = require("./aura"), Source = require("./source"), Search = require("./search"), root = this, OA = OA || {};
        return typeof exports != "undefined" ? (typeof module != "undefined" && module.exports && (exports = module.exports = OA), exports.OA = OA) : (root.OA = OA, !1 in root && (root.require = require)), OA.initialize = initialize, OA.ArtistInfo = ArtistInfo, OA.Aura = Aura, OA.Source = Source, OA.Search = Search, OA;
    }), require([ "app/all" ]);
})();;