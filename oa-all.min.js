...
.each(this._data, fn);
    ...
    }), define("app/artistInfo", [ "require", "jquery", "underscore"
, "./util", "./api", "./mediaCollection" ], function(require) {
...
: function() {
    ...
    }), define("app/particleCollection", [ "require"
, "underscore", "./util", "./particle", "./media" ], function(require) {
...
return p.media().within(minW, minH, maxW, maxH).length() > 0;
        ...
        var $ = require("jquery"), _ = require("underscore"), util = require("./util"), api = require("./api"), prop = util.getProperty, Particle = require("./particle"), ParticleCollection = require
("./particleCollection"), MediaCollection = require("./mediaCollection"), Media = require("./media");
        function Aura(data) {
            this._data = Object.freeze({
...
handle: this.handle(),
        ...
        var initialize = require("./initialize"), ArtistInfo = require("./artistInfo"
), Aura = require("./aura"), Source = require("./source"), root = this, OA = OA || {};
