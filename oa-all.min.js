...
function(data, textStatus, jqXHR) {
            ...
            }, api.infoRequest = function(endpoint, params, 
callback, method) {
        ...
        var util = require("./util"), prop = util
.getProperty;
        function Media(data) {
        ...
        return MediaCollection.prototype = {
            smallerThan: function(w, h) {
                return new MediaCollection(_.chain(this._data)
.filter(function(m) {
        ...
        function ArtistInfo(data) {
            this._data = Object.freeze({
                ...
                profilePhoto: new 
MediaCollection(prop(data, "profile_photo.media") || prop(data, "profile_photo")),
...
return this._data.source;
    ...
    }), define("app/particleCollection", [ "require", "underscore"
, "./util", "./particle", "./media" ], function(require) {
