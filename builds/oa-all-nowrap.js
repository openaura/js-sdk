...
define("app/initialize", [ "require" ], function(require) {
    return function(config) {
        var root = this, OA = root.OA || {};
        OA.config = function() {
            return Object.freeze({
                base_api_url: "http://openaura-prod.apigee.net/v1",
...
}), define("app/api", [ "require", "jquery" ], function(require) {
    var $ = require("jquery"), OA_API = function(api) {
        ...
        function key(type) {
            return type == "stream" ? OA.config().stream_key : OA.config().info_key;
        }
        return api.streamRequest = function(endpoint, params, callback, method) {
            var api_call = prep(endpoint, params, callback, method), config = OA.config();
...
return api_call.data.limit = config.max_particles, api_call.data.api_key = key("stream"), api_call.url = config.base_api_url + "/stream/" + endpoint + "?callback=?", $.ajax(api_call);
            ...
            return api_call.data.api_key = key("info"), api_call.url = OA.config().base_api_url + "/info/" + endpoint, $.ajax(api_call);
        }, api;
    }(OA_API || {});
    return OA_API;
...
return m.asObject();
    ...
    var $ = require("jquery"), _ = require("underscore"), util = require("./util"), api = require("./api"), prop = util.getProperty, MediaCollection = require("./mediaCollection");
...
return this.filter(function(p) {
    ...
    var $ = require("jquery"
), _ = require("underscore"), util = require("./util"), api = require("./api"), prop = util.getProperty, Particle = require("./particle"), ParticleCollection = require("./particleCollection"), MediaCollection = require("./mediaCollection"), Media = require("./media");
    function Aura(data) {
        this._data = Object.freeze({
    ...
    }, Aura.fetchByOaArtistId = function(id
, cb) {
    ...
    return OA.initialize = initialize, OA.ArtistInfo = ArtistInfo, OA.Aura = Aura, typeof exports != "undefined" ? (typeof module != "undefined" && 
module.exports && (exports = module.exports = _), exports._ = _) : root._ = _, OA;
});;