...
(waiting, name) && (waiting[name] = [ name, deps, callback ]);
        ...
        var rootjQuery, readyList, core_strundefined = typeof undefined, location = window.location, document = window.document, docElem = document.documentElement, _jQuery = window.jQuery, _$ = window.$, class2type = 
{}, core_deletedIds = [], core_version = "2.0.3", core_concat = core_deletedIds.concat, core_push = core_deletedIds.push, core_slice = core_deletedIds.slice, core_indexOf = core_deletedIds.indexOf, core_toString = class2type.toString, core_hasOwn = class2type.hasOwnProperty, core_trim = core_version.trim, jQuery = function(selector, context) {
...
();
        ...
        var $ = require("jquery"
), _ = require("underscore"), util = require("./util"), api = require("./api"), prop = util.getProperty, MediaCollection = require("./mediaCollection");
...
cb(new Aura(data));
    ...
    }), define("app/all", [ "require", "./initialize", "./artistInfo", "./aura" ], function(require) {
        var initialize = require("./initialize"), ArtistInfo = require("./artistInfo"), Aura = require("./aura"), root = this, OA = OA || {};
        return OA.initialize = initialize, OA.ArtistInfo = ArtistInfo, OA.Aura = Aura, typeof exports != "undefined" ? (typeof module != "undefined" && module.exports && (exports = module.exports = _), exports._ = _) : root._ = _, OA;
    }), require([ "app/all" ]);
})();;