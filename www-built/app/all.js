...
(waiting, name) && (waiting[name] = [ name, deps, callback ]);
        ...
        var rootjQuery, readyList, core_strundefined = typeof undefined, location = window.location, document = window.document, docElem = document.documentElement, _jQuery = window.jQuery, _$ = window.$, 
...
(document, [ jQuery ]), jQuery.fn.trigger && jQuery(document).trigger("ready").off("ready");
            },
...
(function(p) {
    ...
    }), define("app/aura", [ "require", "jquery", "underscore", "./util", "./api", "./particle", "./particleCollection", "./mediaCollection"
, "./media" ], function(require) {
    ...
    }), define("app/source", [ "require", "./util", "./api" ], function(require) {
        var util = require("./util"), prop = util.getProperty
, api = require("./api");
...
uid: this.uid(),
        ...
        var initialize = require("./initialize"), ArtistInfo = 
require("./artistInfo"), Aura = require("./aura"), Source = require("./source"), root = this, OA = OA || {};
