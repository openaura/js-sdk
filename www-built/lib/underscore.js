...
(function() {
    ...
    typeof exports != "undefined" ? (typeof module != "undefined" && module.exports && (exports = module.exports = _), exports.
_ = _) : root._ = _, _.VERSION = "1.5.2";
...
obj, iterator, context) {
    ...
    _
.contains = _.include = function(obj, target) {
...
array, n, guard) {
    ...
    _.flatten = function(array, shallow) {
        ...
        return _.difference(array, slice
.call(arguments, 1));
...
obj[f], obj);
        ...
        return function() {
            var now = new Date;
            !previous && 
options.leading === !1 && (previous = now);
...
.values = function(obj) {
    ...
    var eq = function(a, b, aStack, bStack) {
        ...
        a instanceof 
_ && (a = a._wrapped), b instanceof _ && (b = b._wrapped);
